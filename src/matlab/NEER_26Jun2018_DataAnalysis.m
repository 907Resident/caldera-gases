...
% Calculate the relative time for each measurement 
    ...
    TT_PicData = addvars(TT_PicData,NEER_26Jun2018,                     ...
                        'Before','HP_CH4_dry');
...
RN(i) = 1;
    ...
    % measurement vectors
RN_CH4 = [RN, datenum(TT_PicData.Time), NEER_26Jun2018          ...
...
for idx = 1:nchams
    ...
    % ChamON
        % Pre-allocate
    NEER_ChamON_DateTimes           = NaT([375 1 nchams]);
for idx = 1:nchams
