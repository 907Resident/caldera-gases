...
% the 0's will indicate rows that are to be removed.
    % For the VCSS_10Jul2017, the data presented groups of four thus, only
...
% Reassign the variables so that they represent the filtered information
    ...
    smry_VCSS_10Jul2017 = summary(TT_VCSS);
    % Clear extraneous variables
...
subplot(1,2,1)
    plot(TT_VCSS.Time, TT_VCSS.HP_CH4_dry, 'o')
        title('VCSS 10Jul2017 [CH_4] vs. Timestamp (ALL)')
        ylabel('[CH_4] (ppm)')
        grid on
%------Figure 1B-------%
subplot(1,2,2)
    plot(TT_VCSS.Time, TT_VCSS.CO2_dry, 'mo')
        title('VCSS 10Jul2017 [CO_2] vs. Timestamp (ALL)')
        ylabel('[CO_2] (ppm)')
        grid on
...
% --- CH4 --- %
   h1 = plot(TT_VCSS.Time,TT_VCSS.HP_CH4_dry, 'o');
                    title('VCSS 10Jul2017 [CH_4] and [CO_2] vs. Time')
                    grid on
...
['10:57:30'; '11:29:57'; '13:01:01'; '13:31:30'; '13:57:32'],           ...
...
['11:04:48'; '11:33:33'; '13:06:35'; '13:36:09'; '14:02:50'],           ...
 'InputFormat', 'HH:mm:ss');
    % Extract the time from the combined date-time value
...
['11:04:58'; '11:33:47'; '13:06:39'; '13:36:13'; '14:02:54'],           ...
 'InputFormat', 'HH:mm:ss');
    % Extract the time from the combined date-time value
...
['11:24:54'; '12:02:16'; '13:10:49'; '13:42:49'; '14:09:06'],           ...
 'InputFormat', 'HH:mm:ss');
...
['11:25:43'; '12:02:16'; '13:12:24'; '13:44:06'; '14:10:34'],           ...
 'InputFormat', 'HH:mm:ss');

PostBack_Times(:,1)             = DATE + timeofday(PostBack_Times(:,1));

PostBack_Times(:,2)             = datetime(                             ...
['11:28:04'; '12:02:23'; '13:17:39'; '13:49:56'; '14:14:16'],                                   ...
 'InputFormat', 'HH:mm:ss');
