...
working_dir = "E:\moyoa\Documents\OneDrive - Vanderbilt\PhD_Dissertation\Data_Analysis\Picarro\Yellowstone\Jun2019\13Jun2019\";
...
%% Gather the MMTH Data from the Eosense Matrix 'PD_mtrx'
...
% the 0's will indicate rows that are to be removed.
    % For the MMTH, the data presented groups of four thus, only
...
%       legend({'Linear Model', 'Exponential Model'}, 'Location', 'SW')
        xticks(1:nchams)
        xticklabels({'3.3', '3.4', '2.2', '2.5', '2.6'})
        hold off
        % Density Plot
        nexttile
