...
% working_dir = "E:\moyoa\Documents\OneDrive - Vanderbilt\PhD_Dissertation\Data_Analysis\Picarro\valles\Jun2018\08Jul2017\";
...
data_dir = fullfile(fileparts(fileparts(working_dir)),                  ...
    "non-pertinent-data/dat-files/valles/VCSS/08Jul2017");
...
%% Gather the VCSS_08Jul2017 Data from the Forerunner Matrix 'PD_mtrx'
...
subplot(1,2,1)
    plot(TT_VCSS.Time, TT_VCSS.HP_CH4_dry, 'o')
        title('VCSS 08Jul2017 [CH_4] vs. Timestamp (ALL)')
        ylabel('[CH_4] (ppm)')
        grid on
%------Figure 1B-------%
subplot(1,2,2)
    plot(TT_VCSS.Time, TT_VCSS.CO2_dry, 'mo')
        title('VCSS 08Jul2017 [CO_2] vs. Timestamp (ALL)')
        ylabel('[CO_2] (ppm)')
        grid on
...
['08-Jul-2017 12:10:40'; '08-Jul-2017 12:52:41'; '08-Jul-2017 13:25:22';...
 '08-Jul-2017 13:44:06'],                                               ...
 'InputFormat', 'dd-MMM-yyyy HH:mm:ss');

PreBack_Times(:,2)              = datetime(                             ...
['08-Jul-2017 12:14:26'; '08-Jul-2017 12:57:17'; '08-Jul-2017 13:33:35';...
 '08-Jul-2017 13:47:39'],                                               ...
 'InputFormat', 'dd-MMM-yyyy HH:mm:ss');
...
['08-Jul-2017 12:14:33'; '08-Jul-2017 12:57:24'; '08-Jul-2017 13:33:46';...
 '08-Jul-2017 13:47:50'],                       ...
 'InputFormat', 'dd-MMM-yyyy HH:mm:ss');

% Fill in with the **"end"** time of each chamber closure period (i.e. the
% time when the chamber opens
ChamON_Times(:,2)               = datetime(                             ...
['08-Jul-2017 12:24:56'; '08-Jul-2017 13:00:33'; '08-Jul-2017 13:39:45';...
 '08-Jul-2017 14:07:16'],                                               ...
 'InputFormat', 'dd-MMM-yyyy HH:mm:ss');
...
['08-Jul-2017 12:30:20'; '08-Jul-2017 13:04:33'; '08-Jul-2017 13:40:31';...
 '08-Jul-2017 14:08:06'],                                               ...
 'InputFormat', 'dd-MMM-yyyy HH:mm:ss');

PostBack_Times(:,2)             = datetime(                             ...
['08-Jul-2017 12:35:03'; '08-Jul-2017 13:09:53'; '08-Jul-2017 13:43:12';...
 '08-Jul-2017 14:08:27'],                                   ...
 'InputFormat', 'dd-MMM-yyyy HH:mm:ss');
...
for idx = 1:nchams
    ...
    % ChamON
        % Pre-allocate
    VCSS_ChamON_DateTimes           = NaT([400 1 nchams]);
for idx = 1:nchams
...
VCSS_ChamON = gas_unit_prep(VCSS_ChamON, metadata.site_temperature_C, metadata.pressure_pa);
...
if writeXL == 1
    ...
    for i = 1:nchams
        ...
        msg_str = sprintf('Tab ''VCSS_%d'' has been created', i);
        disp(msg_str)
    end
