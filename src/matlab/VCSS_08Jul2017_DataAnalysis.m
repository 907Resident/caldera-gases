...
working_dir = "E:\moyoa\Documents\OneDrive - Vanderbilt\PhD_Dissertation\Data_Analysis\Picarro\Valles\VCSS\08July2017\";

% Date of measurements
    % Data for this transect at VCSS was collected over two days but most
    % of the data was collected 08Jul2017. Thus, the date tag is 08Jul2017
ddmmmyyyy   = "08Jul2017";
...
% Import troubled file
import_troubled_VCSS_dat_file

% Concatenate troubled file to the rest
    % Convert troubled table to timetable object
 troubled_dat_file = table2timetable(troubled_dat_file);  
    % Change names of troubled file variables to match
 troubled_dat_file.Properties.VariableNames =                           ...
        TT_PicData.Properties.VariableNames;
    % Vertically concatenate regular and troubled timetables
 TT_PicData = [TT_PicData; troubled_dat_file];

 % Sort Timetable by time
 TT_PicData =  sortrows(TT_PicData, "Time");
 
 % Ensure data encapsulates measuremenst from 08 and 10 Jul 2017
 s = timerange("08-Jul-2017", "11-Jul-2017", "closed");
 TT_PicData = TT_PicData(s,:);
 
%% Gather the VCSS_08Jul2017 Data from the Eosense Matrix 'PD_mtrx'
...
% the 0's will indicate rows that are to be removed.
    % For the VCSS_08Jul2017, the data presented groups of four thus, only
...
% Reassign the variables so that they represent the filtered information
    ...
    smry_VCSS_08Jul2017 = summary(TT_VCSS);
    % Clear extraneous variables
...
subplot(1,2,1)
    plot(TT_VCSS.Time, TT_VCSS.HP_CH4_dry, 'o')
        title('VCSS Jul2017 [CH_4] vs. Timestamp (ALL)')
        ylabel('[CH_4] (ppm)')
        grid on
%------Figure 1B-------%
subplot(1,2,2)
    plot(TT_VCSS.Time, TT_VCSS.CO2_dry, 'mo')
        title('VCSS Jul2017 [CO_2] vs. Timestamp (ALL)')
        ylabel('[CO_2] (ppm)')
        grid on
...
% --- CH4 --- %
   h1 = plot(TT_VCSS.Time,TT_VCSS.HP_CH4_dry, 'o');
                    title('VCSS 08Jul2017 [CH_4] and [CO_2] vs. Time')
                    grid on
...
['08-Jul-2017 12:10:29'; '08-Jul-2017 12:52:41'; '08-Jul-2017 13:42:26';...
 '10-Jul-2017 11:00:25'; '10-Jul-2017 11:51:42'],                       ...
 'InputFormat', 'dd-MMM-yyyy HH:mm:ss');

PreBack_Times(:,2)              = datetime(                             ...
['08-Jul-2017 12:14:33'; '08-Jul-2017 12:57:17'; '08-Jul-2017 13:47:18';...
 '10-Jul-2017 11:04:39'; '10-Jul-2017 11:55:43'],                       ...
 'InputFormat', 'dd-MMM-yyyy HH:mm:ss');
...
['08-Jul-2017 12:14:37'; '08-Jul-2017 12:57:24'; '08-Jul-2017 13:47:18';...
 '10-Jul-2017 11:04:39'; '10-Jul-2017 11:55:26'],                       ...
 'InputFormat', 'dd-MMM-yyyy HH:mm:ss');

% Fill in with the **"end"** time of each chamber closure period (i.e. the
% time when the chamber opens
ChamON_Times(:,2)               = datetime(                             ...
['08-Jul-2017 12:24:59'; '08-Jul-2017 13:00:37'; '08-Jul-2017 14:07:45';...
 '10-Jul-2017 11:24:55'; '10-Jul-2017 12:02:21'],                                   ...
 'InputFormat', 'dd-MMM-yyyy HH:mm:ss');
...
['08-Jul-2017 12:30:20'; '08-Jul-2017 13:04:33'; '08-Jul-2017 14:08:06';...
 '10-Jul-2017 11:25:45'; '10-Jul-2017 12:02:17'],                       ...
 'InputFormat', 'dd-MMM-yyyy HH:mm:ss');

PostBack_Times(:,2)             = datetime(                             ...
['08-Jul-2017 12:35:03'; '08-Jul-2017 13:09:53'; '08-Jul-2017 14:08:27';...
 '10-Jul-2017 11:30:34'; '10-Jul-2017 12:02:21'],                                   ...
 'InputFormat', 'dd-MMM-yyyy HH:mm:ss');
