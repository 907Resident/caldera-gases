...
%% WTHB_WTHB_DataAnalysis

% WTHB_WTHB_DataAnalysis
% Geoscientists: Ajayi, M. & Mans, W.
% Location: West Thumb (WTHB), Yellowstone National Park, WY 
% [44.4182, -110.5726]
% Data Type: Transect Measurements 
% Metadata File: "...\Yellowstone\Jul2018\WTHB\WTHB_WTHB_Metadata"
...
% working_dir = "E:\moyoa\Documents\OneDrive - Vanderbilt\PhD_Dissertation\Data_Analysis\Picarro\Yellowstone\Jun2018\01Jul2018\";
...
data_dir = fullfile(fileparts(fileparts(working_dir)),                  ...
    "non-pertinent-data/dat-files/yellowstone/01Jul2018");
...
%% Gather the WTHB_01Jul2018 Data from the Forerunner Matrix 'PD_mtrx'
...
% the 0's will indicate rows that are to be removed.
    % For the WTHB_01Jul2018, the data presented groups of four thus, only
...
% Reassign the variables so that they represent the filtered information
    ...
    smry_WTHB_01Jul2018 = summary(TT_WTHB);
    % Clear extraneous variables
...
subplot(1,2,1)
    plot(TT_WTHB.Time, TT_WTHB.HP_CH4_dry, 'o')
        title('WTHB 01Jul2018 [CH_4] vs. Timestamp (ALL)')
        ylabel('[CH_4] (ppm)')
        grid on
%------Figure 1B-------%
subplot(1,2,2)
    plot(TT_WTHB.Time, TT_WTHB.CO2_dry, 'mo')
        title('WTHB 01Jul2018 [CO_2] vs. Timestamp (ALL)')
        ylabel('[CO_2] (ppm)')
        grid on
...
% --- CH4 --- %
   h1 = plot(TT_WTHB.Time,TT_WTHB.HP_CH4_dry, 'o');
                    title('WTHB 01Jul2018 [CH_4] and [CO_2] vs. Time')
                    grid on
...
['12:51:52'; '13:33:28'; '14:25:36'; '14:57:22'; '16:32:42'],           ...
...
['12:56:52'; '13:38:35'; '14:30:19'; '15:52:53'; '16:37:49'],           ...
 'InputFormat', 'HH:mm:ss');
    % Extract the time from the combined date-time value
...
['12:56:55'; '13:38:39'; '14:30:23'; '15:52:56'; '16:37:52'],           ...
 'InputFormat', 'HH:mm:ss');
    % Extract the time from the combined date-time value
...
['13:17:52'; '13:59:16'; '14:51:22'; '16:13:03'; '16:58:33'],           ...
 'InputFormat', 'HH:mm:ss');
...
['13:18:52'; '14:00:26'; '14:52:01'; '16:14:02'; '16:59:15'],           ...
 'InputFormat', 'HH:mm:ss');

PostBack_Times(:,1)             = DATE + timeofday(PostBack_Times(:,1));

PostBack_Times(:,2)             = datetime(                             ...
['13:22:36'; '14:04:38'; '14:56:05'; '16:18:16'; '17:03:49'],           ...
 'InputFormat', 'HH:mm:ss');
...
%% Extract the individual measurement
    ...
    WTHB_PreBack    = NaN([115, width(TT_WTHB)+1, nchams]); 
    WTHB_ChamON     = NaN([400, width(TT_WTHB)+1, nchams]);
    WTHB_PostBack   = NaN([115, width(TT_WTHB)+1, nchams]);
...
for idx = 1:nchams
    ...
    % ChamON
        % Pre-allocate
    WTHB_ChamON_DateTimes           = NaT([400 1 nchams]);
for idx = 1:nchams
...
WTHB_ChamON = gas_unit_prep(WTHB_ChamON, metadata.site_temperature_C, metadata.pressure_pa);
...
if writeXL == 1
    ...
    for i = 1:nchams
        ...
        msg_str = sprintf('Tab ''WTHB_%d'' has been created', i);
        disp(msg_str)
    end
