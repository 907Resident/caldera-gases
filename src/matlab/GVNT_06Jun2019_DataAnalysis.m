...
%% GVNT_06Jun2019_DataAnalysis

% GVNT_06Jun2019_DataAnalysis
% Geoscientists: Ajayi, M. & Ayers, J.
% Location: Gas Vents (Solfatara Springs), Yellowstone National Park, WY 
% [44.7095038888889, -110.553565555556]
...
working_dir = "E:\moyoa\Documents\OneDrive - Vanderbilt\PhD_Dissertation\Data_Analysis\Picarro\Yellowstone\Jun2019\06Jun2019\";
...
%% Gather the GVNT_06Jun2019 Data from the Eosense Matrix 'PD_mtrx'
...
weather_file = "E:\moyoa\Documents\OneDrive - Vanderbilt\Python\Yellowstone-Python\GVNT\GVNT_06Jun2019_Weather.csv";
...
% the 0's will indicate rows that are to be removed.
    % For the GVNT, the data presented groups of four thus, only
...
subplot(1,2,1)
    plot(TT_GVNT.Time, TT_GVNT.HP_CH4_dry, 'o')
        title('GVNT 06Jun2019 [CH_4] vs. Timestamp (ALL)')
        ylabel('[CH_4] (ppm)')
        grid on
%------Figure 1B-------%
subplot(1,2,2)
    plot(TT_GVNT.Time, TT_GVNT.CO2_dry, 'mo')
        title('GVNT 06Jun2019 [CO_2] vs. Timestamp (ALL)')
        ylabel('[CO_2] (ppm)')
        grid on
...
% --- CH4 --- %
   h1 = plot(TT_GVNT.Time,TT_GVNT.HP_CH4_dry, 'o');
                    title('GVNT 06Jun2019 [CH_4] and [CO_2] vs. Time')
                    grid on
...
['11:10:00'; '11:44:01'; '12:22:03'; '13:57:12'; '14:22:06'; '14:52:26';...
 '15:39:02'],                                                           ...
...
['11:15:44'; '11:49:53'; '12:27:56'; '13:59:30'; '14:27:16'; '14:57:44';...
 '15:43:58'],                                                           ...
 'InputFormat', 'HH:mm:ss');
    % Extract the time from the combined date-time value
...
['11:15:48'; '11:49:57'; '12:26:56'; '13:59:30'; '14:27:20'; '14:57:48';...
 '15:44:02'],                                                           ...
 'InputFormat', 'HH:mm:ss');
    % Extract the time from the combined date-time value
...
['11:33:27'; '12:04:49'; '12:35:29'; '14:01:43'; '14:33:03'; '15:12:35';...
 '15:59:12'],                                                           ...
 'InputFormat', 'HH:mm:ss');
...
['11:34:12'; '12:05:41'; '12:40:13'; '14:06:50'; '14:39:17'; '15:13:20';...
 '15:59:51'],                                                           ...
 'InputFormat', 'HH:mm:ss');
...
['11:38:30'; '12:09:53'; '12:44:21'; '14:10:03'; '14:42:54'; '15:17:56';...
 '16:03:31'],                                                           ...
 'InputFormat', 'HH:mm:ss');
...
%% Extract the Individual Measurement
    ...
    GVNT_ChamON     = NaN([420, width(TT_GVNT)+1, nchams]);
...
% Converting constants
    ...
    Temp                        = mean(Weather_Data.AmbientTemp);
    Press                       = mean(Weather_Data.Pressure);
...
%       legend({'Linear Model', 'Exponential Model'}, 'Location', 'SW')
        xticks(1:nchams)
        xticklabels({'3.1', '3.2', '3.3', '4.1', '4.2', '4.3', '4.4'})
        hold off
        % Density Plot
        nexttile
