...
%% MMTH_21Jun2018_Data Analysis

% MMTH_21Jun2018_DataAnalysis
% Geoscientists: Ajayi, M. & Mans, W.
% Location: Mammoth Hot Springs (MMTH), Yellowstone National Park, WY
% Data Type: Transect Measurements 
% Metadata File: To be created (07 Aug 2018)
...
working_dir = "E:\moyoa\Documents\OneDrive - Vanderbilt\PhD_Dissertation\Data_Analysis\Picarro\Yellowstone\Jun2018\21Jun2018\";
...
%% Gather the MMTH_21Jun2018 Data from the Forerunner Matrix 'PD_mtrx'
...
% the 0's will indicate rows that are to be removed.
    % For the MMTH_21Jun2018, the data presented groups of four thus, only
...
% Reassign the variables so that they represent the filtered information
    ...
    smry_MMTH_21Jun2018 = summary(TT_MMTH);
    % Clear extraneous variables
...
subplot(1,2,1)
    plot(TT_MMTH.Time, TT_MMTH.HP_CH4_dry, 'o')
        title('MMTH 21Jun2018 [CH_4] vs. Timestamp (ALL)')
        ylabel('[CH_4] (ppm)')
        grid on
%------Figure 1B-------%
subplot(1,2,2)
    plot(TT_MMTH.Time, TT_MMTH.CO2_dry, 'mo')
        title('MMTH 21Jun2018 [CO_2] vs. Timestamp (ALL)')
        ylabel('[CO_2] (ppm)')
        grid on
...
% --- CH4 --- %
   h1 = plot(TT_MMTH.Time,TT_MMTH.HP_CH4_dry, 'o');
                    title('MMTH 21Jun2018 [CH_4] and [CO_2] vs. Time')
                    grid on
...
['09:38:01'; '09:53:04'; '10:19:07'; '12:12:03'; '12:39:30'; '13:16:40';...
 '14:00:01'; '16:01:30'],                                               ...
...
['09:45:02'; '10:00:31'; '10:24:49'; '12:18:33'; '12:44:53'; '13:22:26';...
 '14:06:24'; '16:07:36'],                                               ...
 'InputFormat', 'HH:mm:ss');
...
['09:48:28'; '10:04:29'; '10:27:52'; '12:27:42'; '13:01:49'; '13:43:18';...
 '14:26:33'; '16:26:26'],                                               ...
 'InputFormat', 'HH:mm:ss');
...
for idx = 1:nchams
    ...
    % ChamON
        % Pre-allocate
    MMTH_ChamON_DateTimes           = NaT([365 1 nchams]);
for idx = 1:nchams
...
fig08 = figure;
    %  CH4
        subplot(1,2,1)
            ...
            grid on
            title('MMTH 21Jun2018 | CH_4 Fluxes')
            xlabel('Location')
            ylabel('F_{CH_4} (mg m^{-2} hr^{-1})')
            legend({'Linear Model', 'Exponential Model'}, 'Location', 'SW')
            xticklabels({'1.1','1.2','1.3','2.1','2.2','2.3','2.4','3.1'})
            hold off
    % CO2
        subplot(1,2,2)
            ...
            grid on
            title('MMTH 21Jun2018 | CO_2 Fluxes')
            xlabel('Location')
...
for i = 1:nchams
    ...
    filename = working_dir+"MMTH_21Jun2018_MATFILE.mat";
    save(filename,                                                      ...
