...
%% MDVC_25Jun2018_DataAnalysis

% MDVC_25Jun2018_DataAnalysis
% Geoscientists: Ajayi, M. & Mans, W.
% Location: Mud Volcano (MDVC), Yellowstone National Park, WY 
% [44.620294, -110.435284]
% Data Type: Transect Measurements 
% Metadata File: "...\Yellowstone\June2018\25Jun2018\MDVC_25Jun2018_Metadata"
...
working_dir = "E:\moyoa\Documents\OneDrive - Vanderbilt\PhD_Dissertation\Data_Analysis\Picarro\Yellowstone\Jun2018\25Jun2018\";
...
%% Gather the MDVC_25Jun2018 Data from the Eosense Matrix 'PD_mtrx'
...
%%  Get Rid of the Duplicate Measurement  Value
...
% the 0's will indicate rows that are to be removed.
    % For the MDVC_25Jun2018, the data presented groups of four thus, only
...
% Reassign the variables so that they represent the filtered information
    ...
    % *TT_MDVC_25Jun2018*
    TT_MDVC_25Jun2018 = timetable(Time, RN_CH4(:,03),  RN_CH4(:,04),    ...
    ...
    smry_MDVC_25Jun2018 = summary(TT_MDVC_25Jun2018);
    % Clear extraneous variables
...
%------Figure 1A-------%
subplot(1,2,1)
    plot(TT_MDVC_25Jun2018.Time, TT_MDVC_25Jun2018.HP_CH4_dry, 'o')
        title('MDVC 25Jun2018 [CH_4] vs. Timestamp (ALL)')
        ylabel('[CH_4] (ppm)')
        grid on

%------Figure 1B-------%
subplot(1,2,2)
    plot(TT_MDVC_25Jun2018.Time, TT_MDVC_25Jun2018.CO2_dry, 'mo')
        title('MDVC 25Jun2018 [CO_2] vs. Timestamp (ALL)')
        ylabel('[CO_2] (ppm)')
        grid on
...
yyaxis left
% --- CH4 --- %
   h1 = plot(TT_MDVC_25Jun2018.Time,TT_MDVC_25Jun2018.HP_CH4_dry, 'o');
                    title('MDVC 25Jun2018 [CH_4] and [CO_2] vs. Time')
                    grid on
...
yyaxis right                    
% --- CO2 --- %
   h2 = plot(TT_MDVC_25Jun2018.Time,TT_MDVC_25Jun2018.CO2_dry, 'o');
                    h2.Marker               = 'o';
                    h2.LineStyle            = 'none';
                    h2.Color                = [1 0 1];
                    ylabel('[CO_2] (ppm)')
...
['11:47:02'; '12:40:06'; '13:24:54'; '14:10:29'; '15:03:15';            ...
 '15:55:57'],'InputFormat', 'HH:mm:ss');
...
%% Extract the Individual Measurement
    ...
    MDVC_PreBack    = NaN([100, width(TT_MDVC_25Jun2018)+1, nchams]);
    MDVC_ChamON     = NaN([420, width(TT_MDVC_25Jun2018)+1, nchams]);
    MDVC_PostBack   = NaN([100, width(TT_MDVC_25Jun2018)+1, nchams]);
    
for i = 1:nchams
    % PreBack
    S_Pre           = timerange(PreBack_Times(i,1), PreBack_Times(i,2), ...
                               'closed');
    T               = TT_MDVC_25Jun2018(S_Pre,:);
...
% Add the converted cgs concentrations to the main numeric array
 for idx = 1:nchams
        MDVC_ChamON(:,10,idx)    = c_CH4_cgs(:,1,idx);
        MDVC_ChamON(:,11,idx)    = c_CO2_cgs(:,1,idx);
 end
...
%         end
        ...
        xticklabels({'1.1', '1.2', '1.3', '1.4', '1.5', '1.6'})
