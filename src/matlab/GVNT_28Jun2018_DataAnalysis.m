...
% Metadata File: "...\Yellowstone\June2018\28Jun2018\GVNT_28Jun2018_Metadata"
...
working_dir = "E:\moyoa\Documents\OneDrive - Vanderbilt\PhD_Dissertation\Data_Analysis\Picarro\Yellowstone\Jun2018\28Jun2018\";
...
%% Gather the GVNT_28Jun2018 Data from the Eosense Matrix 'PD_mtrx'
...
% the 0's will indicate rows that are to be removed.
    % For the GVNT_28Jun2018, the data presented groups of four thus, only
...
% Reassign the variables so that they represent the filtered information
    ...
    smry_GVNT_28Jun2018 = summary(TT_GVNT);
    % Clear extraneous variables
...
subplot(1,2,1)
    plot(TT_GVNT.Time, TT_GVNT.HP_CH4_dry, 'o')
        title('GVNT 28Jun2018 [CH_4] vs. Timestamp (ALL)')
        ylabel('[CH_4] (ppm)')
        grid on
...
subplot(1,2,2)
    plot(TT_GVNT.Time, TT_GVNT.CO2_dry, 'mo')
        title('GVNT 28Jun2018 [CO_2] vs. Timestamp (ALL)')
        ylabel('[CO_2] (ppm)')
        grid on
...
% --- CH4 --- %
   h1 = plot(TT_GVNT.Time,TT_GVNT.HP_CH4_dry, 'o');
                    title('GVNT 28Jun2018 [CH_4] and [CO_2] vs. Time')
                    grid on
...
['11:31:37'; '11:57:12'; '12:32:36'; '13:11:17'; '14:51:36'; '15:22:54';...
 '15:46:47'; '16:12:06'],                                               ...
...
['11:36:29'; '12:02:04'; '12:36:46'; '13:16:18'; '14:56:36'; '15:26:57';...
 '15:51:54'; '16:17:20'],                                               ...
 'InputFormat', 'HH:mm:ss');
    % Extract the time from the combined date-time value
...
['11:37:00'; '12:02:36'; '12:38:04'; '13:16:36'; '14:57:22'; '15:27:00';...
 '15:52:36'; '16:18:50'],                                               ...
 'InputFormat', 'HH:mm:ss');
...
['11:41:11'; '12:05:23'; '12:58:26'; '13:37:18'; '15:03:58'; '15:28:51';...
 '15:55:57'; '16:21:31'],                                               ...
 'InputFormat', 'HH:mm:ss');
...
['11:47:42'; '12:09:49'; '12:59:47'; '13:38:04'; '15:05:30'; '15:35:35';...
 '16:01:26'; '16:25:53'],                                               ...
 'InputFormat', 'HH:mm:ss');
...
['11:51:49'; '12:15:05'; '13:04:56'; '13:41:00'; '15:10:34'; '15:40:35';...
 '16:06:09'; '16:28:18'],                                               ...
 'InputFormat', 'HH:mm:ss');
