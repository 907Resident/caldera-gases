...
data_dir = fullfile(fileparts(fileparts(working_dir)),                  ...
    "non-pertinent-data/dat-files/yellowstone/28Jun2018");
...
%% Gather the GVNT_28Jun2018 Data from the Forerunner Matrix 'PD_mtrx'
...
GVNT_ChamON = gas_unit_prep(GVNT_ChamON, metadata.site_temperature_C, metadata.pressure_pa);
