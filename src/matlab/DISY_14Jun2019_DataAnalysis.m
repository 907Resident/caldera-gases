...
% GPS Coordinates: [44.470048, -110.844149]
...
working_dir = "E:\moyoa\Documents\OneDrive - Vanderbilt\PhD_Dissertation\Data_Analysis\Picarro\Yellowstone\Jun2019\14Jun2019\";
...
%% Gather the DISY Data from the Eosense Matrix 'PD_mtrx'
...
subplot(1,2,1)
    plot(TT_DISY.Time, TT_DISY.HP_CH4_dry, 'o')
        title('DISY STMB 14Jun2019 [CH_4] vs. Timestamp (ALL)')
        ylabel('[CH_4] (ppm)')
        grid on
...
subplot(1,2,2)
    plot(TT_DISY.Time, TT_DISY.CO2_dry, 'mo')
        title('DISY STMB 14Jun2019 [CO_2] vs. Timestamp (ALL)')
        ylabel('[CO_2] (ppm)')
        grid on
...
% --- CH4 --- %
   h1 = plot(TT_DISY.Time,TT_DISY.HP_CH4_dry, 'o');
                    title('DISY STMB 14Jun2019 [CH_4] and [CO_2] vs. Time')
                    grid on
...
['10:47:29'; '11:08:15'; '11:28:22'; '11:48:09'; '12:07:59'; '12:27:55';...
 '12:47:56'],                                                           ...
...
['10:52:11'; '11:12:23'; '11:32:22'; '11:52:37'; '12:12:30'; '12:32:23';...
 '12:52:20'],                                                           ...
 'InputFormat', 'HH:mm:ss');
    % Extract the time from the combined date-time value
...
['10:52:14'; '11:12:26'; '11:32:26'; '11:52:40'; '12:12:33'; '12:32:26';...
 '12:52:24'],                                                           ...
 'InputFormat', 'HH:mm:ss');
...
['11:07:16'; '11:26:47'; '11:47:13'; '12:07:10'; '12:27:17'; '12:47:10';...
 '13:06:24'],                                                           ...
 'InputFormat', 'HH:mm:ss');
...
for i = 1:nchams 
    ...
    background_CH4{i,2}          = desc_stats(DISY_PreBack(:,5,i));
         % CO2
    background_CO2{i,1}          = desc_stats(DISY_PreBack(:,7,i));
    background_CO2{i,2}          = desc_stats(DISY_PreBack(:,7,i));   
    ...
    % Save figure as .fig to working directory
    file_str = sprintf("MATLAB_figs\\DISY_14Jun2019_CH4_and_CO2_background_EDA_ncham-%d.fig", i);
